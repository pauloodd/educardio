    ...
    <div id="middle">    
		<div id="middle_align">
            ...
            <c:if test="${arcoMaguerez.faseDoArco > 2}"><div class="desabilitar-form" style="height:100%;"></div>	</c:if>    
                	...
                	<div class="help">
                                <h3 class="arco teorizacao"> Implementação</h3>
                               Tendo elencado os diagnósticos de Enfermagem, opte pelas intervenções a serem realizadas para cada uma das situações encontradas. 
                               </div>
		                ...
		                <tbody id="determinantes-tbody">
		                 	...
		                 	<c:forEach items="${determinantesHipoteses}" var="determinante" varStatus="index">
				            	<tr id='row-<c:out value="${index.index}"/>'>
				                	...
				                	<td></td>
				                	 <td align="center">
				                	 		 <input type="button" value="Adicionar Interveção" id="button"/>
        		...
        		<table class="navegacao" style="position: relative; z-index:2;">
	            	<tr>
		                ...
		                <td class="space"></td>
		            	<td class="left">    
		                	<input type="button" value="Cancelar" onclick="window.location.href = 'teorizacao.do?method=mostrarTelaImplementacao';" class="bt_cancelar" class="left">
		                </td>
		               <td class="right">
