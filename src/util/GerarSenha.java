...
public class GerarSenha {
	...
	// String randomica de tamanho length, contendo apenas caracters
	// alfanumericos
	public static String randomString(int length) {
		return new String(randomCharSequence(length));
	}

	// sequencia de caracters randomicos de tamanho length, contendo apenas
	// alfanumericos
	...
	// sequencia de caracters randomicos de tamanho entre minLength e maxLength,
	// contendo apenas carcters alfanumericos
	public static String randomString(int minLength, int maxLength) {
		...
		if (minLength > maxLength)
			throw new IllegalArgumentException(
					"O tamanho maximo da String não pode ser menor que o minimo");
	...
	public static void main(String[] args) {
		for (int i = 0; i < 200; i++) {
			System.out.println(GerarSenha.randomString(1));  
		}
	}
}